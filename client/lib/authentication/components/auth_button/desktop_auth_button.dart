...
class DesktopAuthButton extends StatefulWidget {
  const DesktopAuthButton({required this.isOnLandingView, super.key});

  final bool isOnLandingView;

  @override
  State<DesktopAuthButton> createState() => _DesktopAuthButtonState();
}

class _DesktopAuthButtonState extends State<DesktopAuthButton> {
  @override
