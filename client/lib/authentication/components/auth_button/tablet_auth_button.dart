...
class TabletAuthButton extends StatefulWidget {
  const TabletAuthButton({required this.isOnLandingView, super.key});

  final bool isOnLandingView;

  @override
  State<TabletAuthButton> createState() => _TabletAuthButtonState();
}

class _TabletAuthButtonState extends State<TabletAuthButton> {
  @override
