...
class MobileAddEntityDialog extends StatelessWidget {
  const MobileAddEntityDialog({this.entity, super.key});
                ...
                children: [
                    ...
                    child: TooltipVisibility(
                      ...
                      child: ReorderableListView.builder(
                            ...
                            (child, index, animation) => Material(
                              ...
                              child: TooltipVisibility(
                                ...
                                child: BlocProvider.value(
                                  value: context.read<EntityEditorCubit>(),
                                  child: child,
                                ),
                              ),
                            ),
                        onReorder: (int oldIndex, int newIndex) {
                          ...
                          setState(() {
                            final Attribute item = localAttributes.removeAt(
                              oldIndex,
                            );
                            ...
                            for (int i = 0; i < localAttributes.length; i++) {
                              localAttributes[i] = localAttributes[i].copyWith(
                                order: i,
                              );
                            }
                          });
                        ...
                        onReorderEnd: (index) {
                          context.read<EntityEditorCubit>().setAttributes(
                            localAttributes,
                          );
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: AttributeRow(
                                    ...
                                    attributeId: localAttributes[index].id,
                                  ),
                                ),
                              ),
                            ),
                  ...
                  Padding(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: context.read<EntityEditorCubit>().addAttribute,
