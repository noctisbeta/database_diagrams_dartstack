...
class DesktopAttributeRow extends StatefulWidget {
  const DesktopAttributeRow({
  ...
  @override
  State<DesktopAttributeRow> createState() => _DesktopAttributeRowState();
}

class _DesktopAttributeRowState extends State<DesktopAttributeRow> {
