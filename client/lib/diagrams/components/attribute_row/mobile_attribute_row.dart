...
class MobileAttributeRow extends StatefulWidget {
  const MobileAttributeRow({
  ...
  @override
  State<MobileAttributeRow> createState() => _MobileAttributeRowState();
}

class _MobileAttributeRowState extends State<MobileAttributeRow> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        AttributeToggle(
                          disabled:
                              attribute.isForeignKey || attribute.isNullable,
                        ...
                        AttributeToggle(
                          disabled:
                              attribute.isPrimaryKey || attribute.isIdentity,
