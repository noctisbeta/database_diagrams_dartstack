...
class TabletDiagramsListDialog extends StatefulWidget {
  const TabletDiagramsListDialog({super.key});

  @override
  State<TabletDiagramsListDialog> createState() =>
      _TabletDiagramsListDialogState();
}

class _TabletDiagramsListDialogState extends State<TabletDiagramsListDialog> {
