...
class DesktopCreateDiagramDialog extends StatefulWidget {
  const DesktopCreateDiagramDialog({required this.onCreateDiagram, super.key});
  ...
  static Future<void> showCreateDiagramDialog(BuildContext context) =>
      showDialog(
        ...
        builder:
            (context) => DesktopCreateDiagramDialog(
  ...
  @override
  State<DesktopCreateDiagramDialog> createState() =>
      _DesktopCreateDiagramDialogState();
}

class _DesktopCreateDiagramDialogState
    extends State<DesktopCreateDiagramDialog> {
