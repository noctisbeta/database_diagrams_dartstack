...
class MobileCreateDiagramDialog extends StatefulWidget {
  const MobileCreateDiagramDialog({required this.onCreateDiagram, super.key});
  ...
  static Future<void> showCreateDiagramDialog(BuildContext context) =>
      showDialog(
        ...
        builder:
            (context) => MobileCreateDiagramDialog(
  ...
  @override
  State<MobileCreateDiagramDialog> createState() =>
      _MobileCreateDiagramDialogState();
}

class _MobileCreateDiagramDialogState extends State<MobileCreateDiagramDialog> {
