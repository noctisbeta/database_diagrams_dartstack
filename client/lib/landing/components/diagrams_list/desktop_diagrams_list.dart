...
class DesktopDiagramsList extends StatefulWidget {
  const DesktopDiagramsList({super.key});

  @override
  State<DesktopDiagramsList> createState() => _DesktopDiagramsListState();
}

class _DesktopDiagramsListState extends State<DesktopDiagramsList> {
