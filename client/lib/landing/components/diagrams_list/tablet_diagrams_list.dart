...
class TabletDiagramsList extends StatefulWidget {
  const TabletDiagramsList({super.key});

  @override
  State<TabletDiagramsList> createState() => _TabletDiagramsListState();
}

class _TabletDiagramsListState extends State<TabletDiagramsList> {
