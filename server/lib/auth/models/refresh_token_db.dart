...
final class RefreshTokenDB extends DataModel {
  ...
  RefreshTokenDB copyWith({
    ...
    ipAddress: ipAddressFn != null ? ipAddressFn() : ipAddress,
    userAgent: userAgentFn != null ? userAgentFn() : userAgent,
    isUsed: isUsed ?? this.isUsed,
    usedAt: usedAtFn != null ? usedAtFn() : usedAt,
    previousToken: previousTokenFn != null ? previousTokenFn() : previousToken,
    isRevoked: isRevoked ?? this.isRevoked,
    revokedAt: revokedAtFn != null ? revokedAtFn() : revokedAt,
    revokeReason: revokeReasonFn != null ? revokeReasonFn() : revokeReason,
  );
}
